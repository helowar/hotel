 ...
 */
public class MyBeanUtil implements Serializable {
	private static final MyLog log = MyLog.getLogger(MyBeanUtil.class);
    static {
        register();
    }
    ...
    public static void copyProperties(Object to, Object from) {
        try {
            ...
            throw new ClassInstantiateException("error when copy properties：" + e);
        }
    }
    ...
    public static List copyCollection(List collection, Class aclass) {
        ...
        for (int m = 0; m < collection.size(); m++) {
            ...
            MyBeanUtil.copyProperties(newObj, obj);
    ...
    public static List getBatchObjectFromParam(Map params, Class aclass, int paramNum) {
        ...
        for (int m = -1; m < paramNum; m++) {
            ...
            if (!properties.isEmpty()
                && !"com.mangocity.hotel.base.persistence.HtlBinding".equals(aclass.getName())) {
