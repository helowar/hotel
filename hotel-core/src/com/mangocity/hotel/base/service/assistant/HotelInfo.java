...
public class HotelInfo implements Serializable {
    ...
    /**
     * 房费需另缴税集合 用于房费需另缴税直接显示结果 v2.9.2 addby chenjuesu
     */
    private List lstRoomTaxCharge;
    ...
    public void setRoomTypes(List<RoomType> rooms) {
    ...
    /*
     * public int getIsSalesPromo() { return isSalesPromo; }
     * 
     * public void setIsSalesPromo(int isSalesPromo) { this.isSalesPromo = isSalesPromo; }
     */
