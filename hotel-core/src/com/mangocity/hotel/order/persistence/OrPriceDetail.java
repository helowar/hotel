 ...
 *  订单价格明细
 */
public class OrPriceDetail implements Entity {

    private static final long serialVersionUID = -1569364299557981773L;
    ...
    private String continueDay = "";
     ...
     /**
     * 最多入住间夜
     * @author lixiaoyong 2009-08-13 v2.9.2
     */
    private String restrictNights = "";
    ...
    /**
     * 连住优惠辅助佣金，用来赋值到OrOrderItem
     * @author chenkeming Feb 18, 2009 11:51:25 AM
     */
    private double commission;
    
    
    //是否是连住优惠 add by shengwei.zuo 2010-1-15
    private boolean isFavourable = false;
    
    
    public boolean getIsFavourable() {
		return isFavourable;
	}

	public void setIsFavourable(boolean isFavourable) {
    ...
    public String getRestrictNights() {
        return restrictNights;
    }

    public void setRestrictNights(String restrictNights) {
        this.restrictNights = restrictNights;
    }
