 ...
 * 
 */
public class OrOrderFaxDao extends DAOHibernateImpl {
    ...
    public Object loadObject(Serializable objID) {
        return (OrOrderFax) super.load(OrOrderFax.class, objID);
    }
     ...
     * @param obj
     */
    public void saveOrUpdate(OrOrderFax obj) {// parasoft-suppress PB.IMC "与父类同名,暂不修改"
        if (null == obj.getID()) {
            insertObject(obj);
        } else
            updateObject(obj);
