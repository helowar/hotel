 ...
 * 
 */
public class OrReservationDao extends DAOHibernateImpl {
    ...
    public Object loadObject(Serializable objID) {
        return (OrReservation) super.load(OrReservation.class, objID);
    }
     ...
     * @param obj
     */
    public void saveOrUpdate(OrReservation obj) {// parasoft-suppress PB.IMC "与父类同名,暂不修改"
        if (null == obj.getID()) {
            insertObject(obj);
        } else
            updateObject(obj);
