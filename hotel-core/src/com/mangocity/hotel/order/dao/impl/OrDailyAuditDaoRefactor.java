 ...
 * 
 */
public class OrDailyAuditDaoRefactor<T> extends GenericDAOHibernateImpl implements IOrDailyAuditDao{
    ...
    public boolean checkUserhasAutoReturnRecord(String loginId){
    	String hsql = "select count(RETURNVISIT_ID) as countRow from DA_RETURNVISIT d where " +
    			"d.ACQUIREID='"+loginId+"' and d.AQUIREWAY = 1";
    	List countRowList = super.query(hsql,null);
    	int countRow =0;
    	if(countRowList.size()>0){
    		Object[] countRowObj = (Object[])countRowList.get(0);
    		Integer inte = (Integer)countRowObj[0];
    		countRow = inte.intValue();
    	}
    	return countRow >= 1 ? true:false;
    }    
    /**
     * 更新回访的订单为以统计
     * @param returnID
    ...
    public DaReturnvisit allotReturnRecordForUserByType(String loginId, String name,int type){
    	...
    	result = super.query(hqlBuildStr.toString(), null);
    ...
    public boolean checkUserhasAutoAuditRecord(String loginId){
    	...
    	List result = super.query(hsql, new Object[]{loginId});
    ...
    public DaDailyaudit allotAuditRecordForUserByType(String loginId, String name,int type){
    	...
    	List result = super.query(hqlBuildStr.toString(), null) ;
    ...
    public String getHotelNameById(Long sid){
    	...
    	List result = super.query(hql, new Object[]{sid}) ;
    	if(result.size() > 0){
	...
	public DaPersonalWorkload getPersonWorkloadByAuditId(String auditorid,int updatePersonelAudit) {
        ...
        return (DaPersonalWorkload)super.query(hql, new Object[]{auditorid,new Integer(updatePersonelAudit)});
	}
	...
	public List getWorkloadByType(int type) {
		...
		return super.query(hsql,new Object[]{(long)type});
	}
	...
	public String getHotelReturnURL(Long auditId) {
		...
		List result = super.query(hsql, new Object[]{String.valueOf(auditId)});
		if(!result.isEmpty())
			return (String)result.get(0);
	...
	public List<DaDailyauditItem> getDaDailyauditItemByOrder(String theOrderCd) {
		...
		return super.query(hql, new Object[]{theOrderCd});
	}
	...
	public Object[] getChaNameByAuditId(Long dailyauditid) {
    	...
    	List result = super.query(hql, new Object[]{dailyauditid}) ;
	...
	public Object[] getHotelComfirmByOrderId(Long orderId, int orderType) {
		...
		List result = super.query(hql, new Object[]{orderId,orderType});
	...
	public void updateAuditItemDataRemark(Long orderId, int orderType, String auditRemark) {
		String hql = null;
		if(1 == orderType)
			hql = "update OrOrder set auditRemark=? where ID=? ";
		else
			hql = "update DaDailyauditItem set remark=? where orderid=? and orderType=2";
	...
	public String getRemark(Long itemId) {
		...
		List result = super.query(hql, new Object[]{itemId});
	...
	public int getNoshowBackCountOrAll(String acquireid, boolean isAll) {
		...
		List result = super.query(hqlBuilder.toString(), new Object[]{acquireid});
	...
	public List<DaDailyauditItem> queryDaDailyauditItemById(long returnVisitID){
		...
		return super.query(hql, new Object[]{returnVisitID});
	}
	...
	public List<DaDailyauditItem> queryDaDailyauditItemByreturnID(Long returnID){
		String hql = "from DaDailyauditItem where returnvisitid = ?";
		return super.query(hql, new Object[]{returnID});
	}
	...
	public Object[] queryDataForDaAuditingWorkload(int type,int re_type){
		...
		if(1 == type)//今天的
			...
			hql = hql.replaceFirst("opt", "<");
		List result = super.query(hql, null);
