...
public class QueryHotelForWebRoomType implements Serializable {
	...
	/**
	 * 是否是底价支付 add by xuyiwen 2010-12-2
	 */
	private boolean judgeMinPrice; 
     ...
     * 预付方式价格明细
     */
    private List<QueryHotelForWebSaleItems> saleItems;

    /**
     * 面付方式价格明细
     */
    private List<QueryHotelForWebSaleItems> faceItems;

    /**
     * 当只有面付或者预付时，保存在这个list中
     */
    private List<QueryHotelForWebSaleItems> itemsList;
     ...
     * add by haibo.li
     */
    private long payBackCash;
    /**
     * 预付返现
     * 诺曼底新加字段 
     * add by haibo.li
     */
    private long prepayBackCash;
    
    private String currencyValue;
    private String prepayCurrencyValue;
    private String payCurrencyValue;

    public long getPayBackCash() {
		return payBackCash;
	}

	public void setPayBackCash(long payBackCash) {
		this.payBackCash = payBackCash;
	}

	public long getPrepayBackCash() {
		return prepayBackCash;
	}

	public void setPrepayBackCash(long prepayBackCash) {
		this.prepayBackCash = prepayBackCash;
	}
     ...
     * 按钮是否灰选的标志
     */
    private boolean falseButton = true;
    
    /**
     * 单个价格类型在入住期间优惠立减总金额 add by chenjiajie 2009-11-13
     */
    private int benefitAmount = 0;
    
    /**
     * 面付配额 add by haibo.li 2010-3-10
     * 用户诺曼底即使确认
     * @return
     */
    private int payAvailQty;
    
    /**
     * 预付配额 add by haibo.li 2010-3-10
     * 用户诺曼底即使确认
     * @return
     */
    private int prePayAvailQty;
    
    
    /**
     * 面付首日房态
     * 房态加入 即使确认个关房判断,得出几种方式:1 有房,可以即使确认2.待确认,需要争取,3.畅联的全显示一样4,关房,无法预订
     */
    private String payRoomType;
     ...
     * 房态加入 即使确认个关房判断,得出几种方式:1 有房,可以即使确认2.待确认,需要争取,3.畅联的全显示一样4,关房,无法预订
     */
    private String prePayRoomtype;
    
    /**
     * 单个价格类型(预付)在入住期间现金返还总金额 add by fanglinpeng 2010-09-27
     */
    private int cashReturnAmount = 0;
    
    /**
     * 单个价格类型(面付)在入住期间现金返还总金额 add by fanglinpeng 2010-09-27
     */
    private int payCashReturnAmount = 0;
	...
	public String getPrePayRoomtype() {
		return prePayRoomtype;
	}

	public void setPrePayRoomtype(String prePayRoomtype) {
		this.prePayRoomtype = prePayRoomtype;
	}

	public int getPayAvailQty() {
		return payAvailQty;
	}

	public void setPayAvailQty(int payAvailQty) {
		this.payAvailQty = payAvailQty;
	}

	public int getPrePayAvailQty() {
		return prePayAvailQty;
	}

	public void setPrePayAvailQty(int prePayAvailQty) {
		this.prePayAvailQty = prePayAvailQty;
	}
    ...
    public List<QueryHotelForWebSaleItems> getSaleItems() {
    	if(null == saleItems) {
    		saleItems = new ArrayList<QueryHotelForWebSaleItems>();
    	}
        return saleItems;
    }
    ...
    public List<QueryHotelForWebSaleItems> getFaceItems() {
    	if(null == faceItems) {
    		faceItems = new ArrayList<QueryHotelForWebSaleItems>();
    	}
        return faceItems;
    }
    ...
    public List<QueryHotelForWebSaleItems> getItemsList() {
    	if(null == itemsList) {
    		itemsList = new ArrayList<QueryHotelForWebSaleItems>();
    	}
        return itemsList;
    }
	...
	public void setBedTypeStr(String bedTypeStr) {
	    ...
	    /**
     * TMC协议酒店设置查询结果的床型字符串
     * @author chenkeming Oct 30, 2009 10:28:07 AM
     * @param bedTypeStr
     */
    public void setTmcBedTypeStr(String bedTypeStr) {
        this.bedTypeStr = null != bedTypeStr ? bedTypeStr : "";
    }
	...
	public String getPrepayCurrencyValue() {
		return prepayCurrencyValue;
	}

	public void setPrepayCurrencyValue(String prepayCurrencyValue) {
		this.prepayCurrencyValue = prepayCurrencyValue;
	}
	...
	public boolean getJudgeMinPrice() {
		return judgeMinPrice;
	}

	public void setJudgeMinPrice(boolean judgeMinPrice) {
		this.judgeMinPrice = judgeMinPrice;
	}

	

	public int getCashReturnAmount() {
		return cashReturnAmount;
	}

	public void setCashReturnAmount(int cashReturnAmount) {
