...
public class HotelListMapSearchAction  extends GenericWebAction{
	...
	private String actionUrl="hotel-list-map-search.shtml";
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3136655474440902854L;
...
//    			      网站改版优化 是否忽略count总数,1:忽略;0:不忽略,默认是0 add by chenjiajie 2009-12-16
			...
			log.error("HotelListMapSearchAction ServiceException error: ",e);
		}
