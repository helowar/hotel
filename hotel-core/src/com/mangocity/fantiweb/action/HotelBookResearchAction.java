	...
	public String execute() {
	     ...
	     // 价格繁体网站的渠道 add by diandian.hou
            ...
            if(hotelOrderFromBean.getIsReduction()==1&&hotelOrderFromBean.getPayMethod().equals("pay")
            		...
            		&&hotelOrderFromBean.getOrderPayType()==7){
...
//	                }
	        ...
	        // 把order中priceNum变为港币，内地预付变，澳门币预付变
	        fantiWebTransactService.orderPriceNumToHKD(hotelOrderFromBean, hotelOrderFromBean.getCurrency());
        return "bookingOrder";
	}
