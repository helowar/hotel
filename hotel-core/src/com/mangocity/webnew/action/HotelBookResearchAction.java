...
//  原始查询条件封闭类
  ...
  //日历控件在前台的显示
	...
	public String execute() {
	        ...
	        /**防止某些时间段因为变价等原因导致酒店房型不可订，然后在订单详细页面，由先前查询出来的可订日期修改为现在的不可订日期依然可订 add by xiaowei.wang begin */
	        ...
	        /**防止某些时间段因为变价等原因导致酒店房型不可订，然后在订单详细页面，由先前查询出来的可订日期修改为现在的不可订日期依然可订 add by xiaowei.wang end */
