...
public class HotelOrderFromBean implements Serializable {
    ...
    private String hotelChnAddress;
    ...
    // "firstNightSalePrice"艺龙担保首日价格
    private Double firstNightSalePrice;
	...
	/**
	 * 0:稍后支付 1:立即支付 add by xiaowei.wang
	 */
    ...
    */
	...
	/**
	 * 单个价格类型在入住期间优惠立减总金额(TODO:是RMB还是原币种？)
	 */
	...
	*/
	...
	/**返现金额  add by xiaojun.xiong 2010-10-9*/
    private Double returnAmount;
    
    private boolean loginBeforeBooking = false;
    
    //商品id
    private Long commodityId;
    
    //是否可订 add by diandian.hou 2011-06-28
    private boolean flag_canbook = true;
    
    private String canntBookReason;
    
    //用于选择最晚到店时间是次日的。add by ting.li
  ...
  //记录订单来源
    ...
    private String isRegisterMember;////1.注册并用新会籍下单；2.当前会籍下单；3.公共会籍下单
	...
	public boolean isLoginBeforeBooking() {
		return loginBeforeBooking;
	}
	public void setLoginBeforeBooking(boolean loginBeforeBooking) {
		this.loginBeforeBooking = loginBeforeBooking;
	}
	 ...
	 * @return
	 */
	public  boolean  isChannelToWith(){
		return this.roomChannel > 0 
		       && this.roomChannel != ChannelType.CHANNEL_ZHX 
		       && this.roomChannel != ChannelType.CHANNEL_CTS;
	}
	public boolean isFlag_canbook() {
		return flag_canbook;
	}
	public void setFlag_canbook(boolean flag_canbook) {
		this.flag_canbook = flag_canbook;
	}
	public String getCanntBookReason() {
		return canntBookReason;
	}
	public void setCanntBookReason(String canntBookReason) {
		this.canntBookReason = canntBookReason;
	}
	public String getHotelChnAddress() {
		return hotelChnAddress;
	}
	public void setHotelChnAddress(String hotelChnAddress) {
		this.hotelChnAddress = hotelChnAddress;
	}
	public Double getFirstNightSalePrice() {
		return firstNightSalePrice;
	}
	public void setFirstNightSalePrice(Double firstNightSalePrice) {
		this.firstNightSalePrice = firstNightSalePrice;
	}
