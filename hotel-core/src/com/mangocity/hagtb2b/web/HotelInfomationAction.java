...
public class HotelInfomationAction extends GenericCCAction {
	...
	public String execute() {
		...
		log.info("HotelInfomationAction flag_showCommission====="+flag_showCommission);
...
//			}
			...
			try {
				hotelInfo = b2bInterfaceService
						.queryHotelInfoBeanForWebs(queryHotelForWebBean);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				log.error("HotelInfomationAction b2bInterfaceService.queryHotelInfoBeanForWebs 报错"+e.getMessage(),e);
			}
