 ...
 *
 */
public interface ITmcOutInterface {		
	 ...
	 * @return
	 */
	public List<HKRoomAmtResponse> enqHKAmtByNation(long hotelId,Date dateFm,Date dateTo,long roomTypeId,String childRoomTypeId);
