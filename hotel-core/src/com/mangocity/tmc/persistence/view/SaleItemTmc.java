 ...
 *
 */
public class SaleItemTmc implements Serializable {
	 ...
	 * 房间价格明细, RoomInfo类
	 */
	private List<RoomInfoTmc> roomItemsTmc = new ArrayList<RoomInfoTmc>();
	...
	public List<RoomInfoTmc> getRoomItems() {
		return roomItemsTmc;
	}

	public void setRoomItems(List<RoomInfoTmc> roomItems) {
		this.roomItemsTmc = roomItems;
	}
	
	public int getWeekNum(){
		return (this.roomItemsTmc.size() - 1) / 7 + 1;
	}
