...
/**
 * 
 * EBooking留言板和酒店区域权限设置记录日志
 * 
 * @author zuoshengwei
 * 
 */
public class LogLeaAndRight extends DAOHibernateImpl implements MethodBeforeAdvice {

    // 日志记录
    private HtlEbookingOperationlog htlEbookingOperationlog = new HtlEbookingOperationlog();
    private static final MyLog log = MyLog.getLogger(LogLeaAndRight.class);
    ...
    public void before(Method arg0, Object[] arg1, Object arg2) throws Throwable {
        ...
        if (null != onlineRoleUser) {
            ...
            // 新增区域权限人员日志记录
            if (arg0.getName().equals("addRightMember")) {

                RightManageBean rightManageBean = new RightManageBean();
                rightManageBean = (RightManageBean) arg1[0];
            ...
            } else if (arg0.getName().equals("delRightMemberById")) {// 删除区域权限人员日志记录

                Long rightIdAdvice = (Long) arg1[0];
            ...
            } else if (arg0.getName().equals("saveLeavewordAnnal")) {// 留言板日志记录

                LeavewordAnnalBean leavewordAnnalBean = new LeavewordAnnalBean();
                leavewordAnnalBean = (LeavewordAnnalBean) arg1[0];
            ...
            } else if (arg0.getName().equals("delLeavewordAnnalById")) {// 删除留言
                Long leavewordAnnaID = (Long) arg1[0];
