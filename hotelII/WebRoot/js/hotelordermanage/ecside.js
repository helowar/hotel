...
ECSideUtil.queryECForm=function(formid,asy,parameter){
	...
	if (ecsideObj == "undefined" || ecsideObj == null){
	    ecsideObj = ECSideList[ECSideConstants.EC_ID];
	    formid = ECSideConstants.EC_ID;
	}
	
	
	if (ecsideObj == null || ecsideObj == "undefined"){
	    alert("can not find ecside object!");
	    return;
	}
	...
	var actionUrl=ecsideObj.ECForm.getAttribute("action");
