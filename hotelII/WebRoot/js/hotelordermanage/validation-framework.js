 ...
 * $Id: validation-framework.js,v 1.1 2006/09/09 02:10:38 administrator Exp $
 */
...
// instead.
var ValidationRoot = "../js/validation/";
...
ValidationFramework.validateDepend = function(field, depend) {
	if (depend.getName() == "required") {
		...
		ValidationFramework.exception("出现异常，Depend:" + depend.getName());
		return false;
	}
}
...
ValidationFramework.getWebFormFieldObj = function(field) {
	...
	if (ValidationFramework._currentForm != null) {
		...
		obj = document.getElementById(field.getName()); //formObj[field.getName()];     //
        //alert("obj name:" + field.getName() + "; obj :" + obj);
...
ValidateMethodFactory.validateRequired = function(field, params) {
    ...
    //alert("filedName:" + field.getName() + ";" + obj.name + ":" + obj.value);
